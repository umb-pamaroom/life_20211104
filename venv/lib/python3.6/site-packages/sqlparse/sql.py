...
class NameAliasMixin:
    ...
    def get_real_name(self):
        ...
        return self._get_name(dot_idx, real_name=True)
...
class TokenList(Token):
    ...
    def _get_name(self, idx=None, reverse=False, keywords=False,
                        real_name=False):
