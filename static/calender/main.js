...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'ja';
    ...
    function buildDateEnv$1(settings) {
        var locale = buildLocale(settings.locale || 'ja', organizeRawLocales([]).map); // TODO: don't hardcode 'ja' everywhere
